...
Set up your development environment with:
    ...
    git clone git@github.com:Opus10/django-pgstrictjson.git
    cd django-pgstrictjson
    make docker-setup
...
Anything that is merged into the main branch will be automatically deployed to PyPI. Documentation will be published to a ReadTheDocs at `https://django-pgstrictjson.readthedocs.io/`.
